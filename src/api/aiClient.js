...
export async function askJohanAI(question, financialData) {
  ...
  return {
    ...
    autopilot: data.autopilot || data.financialData?.autopilot || null,
    safeToSpendAdvanced: data.safeToSpendAdvanced || data.financialData?.safeToSpend || null,
    behavioralInsights: data.behavioralInsights || data.financialData?.behavioralInsights || null,
    disciplineScore: data.disciplineScore || data.financialData?.disciplineScore || null,
    notifications: data.notifications || data.financialData?.notifications || [],
